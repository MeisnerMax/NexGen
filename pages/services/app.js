  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Apps für iOS und Android – klar geplant, sauber umgesetzt, leicht nutzbar. Ideal für kleine Unternehmen." />
        ...
        <meta property="og:description" content="Individuelle Apps für Ihren Alltag – verständlich erklärt und zuverlässig umgesetzt." />
      ...
      <header className="relative overflow-hidden bg-brand-primary text-white">
        ...
        <div className="container mx-auto px-6 lg:px-8 py-20 md:py-28">
          ...
          <p className="mt-3 max-w-2xl text-base md:text-lg text-white/80">Native oder hybride Apps – praxistauglich, schnell und sicher integriert.</p>
      ...
      <section className="py-12 md:py-16 bg-brand-primary">
        <div className="container mx-auto px-6 lg:px-8 grid gap-6 md:grid-cols-3">
          {[
            { title: 'iOS & Android', text: 'Ein Code, zwei Plattformen – effizient und modern.' },
            { title: 'Anbindung', text: 'Verbunden mit Ihren Systemen – sicher und zuverlässig.' },
            { title: 'Einfach zu nutzen', text: 'Klare Oberfläche mit Fokus auf Nutzen.' },
          ].map((f) => (
            <div key={f.title} className="rounded-brand-2xl border border-white/10 bg-gradient-to-br from-indigo-600/40 via-white/10 to-cyan-400/40 transition-all duration-300 group-hover:from-indigo-500/60 group-hover:to-cyan-400/60 p-6 shadow-xl backdrop-blur-md">
      ...
      <section className="py-8 md:py-12 bg-brand-primary text-white">
        <div className="container mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-white/80 max-w-2xl mx-auto">Vom schnellen Start bis zur individuellen Lösung – transparent und planbar.</p>
        </div>
        <div className="container mx-auto px-6 lg:px-8 mt-8 grid gap-6 md:grid-cols-3">
          {[
            { name: 'Basis‑App', msg: 'Basis-App', perks: ['Startscreen','Formulare & Listen','Basis‑Offline'] },
            { name: 'Standard‑App', msg: 'Standard-App', perks: ['Login','API‑Anbindung','Push & Medien'] },
            { name: 'Premium‑App', msg: 'Premium-App', perks: ['Zahlung/Store','Erweiterter Offline','Auswertung'] },
          ].map((p) => (
      ...
      <section className="py-12 md:py-16 bg-brand-primary text-white">
        <div className="container mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-white/80 max-w-2xl mx-auto">Kurzes Erstgespräch, klare Roadmap, zügiger Start.</p>

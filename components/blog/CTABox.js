...
export default function CTABox({ className = '' }) {
  return (
    <section className={`rounded-2xl border border-white/10 bg-white/10 p-8 text-white shadow-xl shadow-black/10 ${className}`}>
      <h2 className="text-2xl font-heading font-semibold">Kostenloses Erstgespraech</h2>
      <p className="mt-3 text-sm leading-relaxed text-white/80">
        Gemeinsam identifizieren wir die naechsten Schritte fuer Digitalisierung, Webdesign oder Prozessautomatisierung in Coburg. 30 Minuten, unverbindlich, konkret.
      </p>

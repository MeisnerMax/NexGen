    ...
    <footer className="bg-[#091B33]  text-white">
      <div className="container mx-auto text-center space-y-6">
        ...
        <div className="flex justify-center gap-4 text-sm">
          <a href="https://www.linkedin.com/company/106936390" className="hover:text-white">LinkedIn</a>
          <a href="https://www.instagram.com/nexgenconsultingcoburg/" className="hover:text-white">Instagram</a>

      ...
      <Card className="space-y-8">
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-slate-600">
            ...
            {siteConfig.address.zip} {siteConfig.address.city}, E-Mail: {siteConfig.email}, Telefon:{' '}
            {siteConfig.phone}.
          </p>
          ...
          <p className="text-sm text-slate-600">
            ...
            E-Mail). Zum anderen automatisch beim Besuch der Website (z. B. IP-Adresse, Zeitstempel,
          ...
          <p className="text-sm text-slate-600">
            Auskunft, Berichtigung, Löschung, Einschränkung, Datenübertragbarkeit, Widerspruch (insb.
            gegen Direktwerbung) und Widerruf erteilter Einwilligungen. Zudem besteht ein
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-slate-600">
            ...
            und effizienten Bereitstellung). Mit dem Hoster besteht ein Vertrag zur
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-slate-600">
            ...
            abgerufene URL, Referrer, User-Agent, Statuscode). Rechtsgrundlage: Art. 6 Abs. 1 lit. f
            DSGVO (Betrieb/Sicherheit). Speicherdauer: i. d. R. ≤ 30 Tage, sofern keine
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-slate-600">
            Wir verwenden technisch notwendige Cookies (ohne Einwilligung zulässig) und – sofern Sie
            zustimmen – funktionale, Statistik- und Marketing-Cookies. Die Einwilligung erfolgt
            über unser Consent-Banner (Art. 6 Abs. 1 lit. a DSGVO; § 25 TTDSG). Sie können Ihre
            Auswahl jederzeit über das Cookie-Banner ändern.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-slate-600">
            Daten aus Anfragen (Name, Kontaktdaten, Inhalt) verarbeiten wir zur Bearbeitung und für
            Anschlussfragen. Rechtsgrundlagen: Art. 6 Abs. 1 lit. b DSGVO (vorvertraglich/vertraglich)
            oder lit. f DSGVO (berechtigtes Interesse an effizienter Kommunikation). Speicherdauer:
            bis Zweckerfüllung, ggf. längere gesetzliche Aufbewahrungsfristen.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-slate-600">
            Wir nutzen Google Analytics (Google Ireland Limited) nur nach Ihrer Einwilligung
            (Art. 6 Abs. 1 lit. a DSGVO). IP-Anonymisierung ist aktiviert. Sie können Ihre
            Einwilligung jederzeit widerrufen. Ggf. findet eine Übermittlung in die USA statt
            (EU-US Data Privacy Framework oder Standardvertragsklauseln). Mit Google besteht ein
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-slate-600">
            Derzeit setzen wir kein Meta-Pixel ein. Sollten wir es zukünftig verwenden, erfolgt die
            Nutzung ausschließlich nach Einwilligung über das Cookie-Banner.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-slate-600">
            Zur Überwachung der Sichtbarkeit im Google-Index kann die Google Search Console genutzt
            werden. Dabei werden uns aggregierte Suchdaten bereitgestellt; es erfolgt keine
            Verarbeitung personenbezogener Tracking-Daten von Websitebesuchern durch uns.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-slate-600">
            ...
            besteht und Ihre Interessen nicht überwiegen. Bei Übermittlungen in Drittländer stellen
            wir ein angemessenes Schutzniveau sicher (z. B. EU-US DPF, Standardvertragsklauseln).
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-slate-600">
            ...
            betreffender personenbezogener Daten, die auf Art. 6 Abs. 1 lit. e oder f DSGVO erfolgt,
            Widerspruch einzulegen; dies gilt auch für ein darauf gestütztes Profiling. Werden Daten
            für Direktwerbung verarbeitet, können Sie dieser Verarbeitung jederzeit widersprechen.
          </p>
        </section>
